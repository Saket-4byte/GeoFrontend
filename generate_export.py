...
export_data_code = """import { useState, useMemo, useEffect } from "react";
import {
  Download,
  FileSpreadsheet,
  FileCode,
...
import type { BackendProject, BackendAlert } from "../types";
...
with open("src/pages/ExportData.tsx", "w", encoding="utf-8") as f:
    f.write(export_data_code)

print("ExportData.tsx written.")
